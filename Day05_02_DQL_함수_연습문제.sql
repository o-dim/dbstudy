...
FROM EMPLOYEES
ORDER BY DEPARTMENT_ID, TO_DATE(HIRE_DATE, 'YY/MM/DD');

-- 12. EMPLOYEES 테이블에서 DEPARTMENT_ID가 80인 사원들을 높은 SALARY순으로 조회하시오. SALARY는 9,000처럼 천 단위 구분기호를 표기해서 조회하시오.
SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME, DEPARTMENT_ID, TO_CHAR(SALARY, '99,999')
FROM EMPLOYEES
...
SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME, FLOOR(MONTHS_BETWEEN(SYSDATE, TO_DATE(HIRE_DATE, 'YY/MM/DD'))) AS 근무개월수
FROM EMPLOYEES;
